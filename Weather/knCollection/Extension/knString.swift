...
extension String {
    ...
    func estimateTextFrame(with font: UIFont, estSize: CGSize) -> CGRect {
        let options = NSStringDrawingOptions.usesFontLeading.union(.usesLineFragmentOrigin)
        return NSString(string: self).boundingRect(with: estSize, options: options, attributes: [NSAttributedStringKey.font: font], context: nil)
    }
}

extension String {
    
    func formatThousandSeparator(_ separatorCharacter: String = " ", fractionCount: Int = 5) -> String {
...
//        formatter.groupingSeparator = separatorCharacter
        ...
        formatter.maximumFractionDigits = fractionCount
